...
<head>
  ...
  <style>
      body {
        ...
        margin-left: 0px;
        margin-right: 0px;
        background-color: rgb(173, 212, 196);
      }
      ul.nav { 
	margin:0px; 
	padding:0;
...
.textoc{
background-color: rgba(239, 240, 235, 0.589);
...
<main>
    ...
    <h4><p></p></h4>
        ...
        <p>&nbsp;&nbsp;Medidas para evitar esse aceleramento focam em evitar o desperdício de água e de energia, 
